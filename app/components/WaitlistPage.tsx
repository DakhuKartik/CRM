        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-6">
              Join the SimpleCRM Waitlist
            </h1>
            <p className="text-lg text-gray-600 mb-8">
              Be among the first to experience the CRM built specifically for small teams. 
              Sign up now and get exclusive early access when we launch.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Get priority access before our public launch
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Lock in exclusive founder pricing for life
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Your feedback will help us build the perfect CRM
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Personal onboarding to get your team started right
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <p className="text-xs text-gray-500 text-center">
                By signing up, you agree to receive updates about BlueTicked. 
